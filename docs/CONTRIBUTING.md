...
If you're having trouble with our code and package please let us know.
...
We typically use the GPL3 license; which permits Commercial Use, Modification, Distribution and Private use of our code, and therefore also your contributions. It also provides good compatibility with other licenses, and is intended to make re-use of our code as painless as possible for all parties.

You can learn more about the GPL3 license at Wikipedia: https://en.wikipedia.org/wiki/GNU_General_Public_License
...
-- The Fusionbase Engineering Team